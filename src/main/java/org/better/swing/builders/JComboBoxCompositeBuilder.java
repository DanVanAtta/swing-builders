...
public class JComboBoxCompositeBuilder {
  ...
  public JComboBoxCompositeBuilder onSelectionShowPanel(final String triggerValue,
      final JComponent componentToReveal) {
  ...
  public JComponent build() {
    ...
    for (final Map.Entry<String, JComponent> entry : componentRevealMap.entrySet()) {
      if (comboBox.getSelectedItem() != null && comboBox.getSelectedItem().toString()
          .equals(entry.getKey())) {
    ...
    comboBox.addItemListener(itemEvent -> {
      ...
      if (triggerValueForPanelHide != null) {
        if (itemEvent.getItem() != null && itemEvent.getItem().toString()
            .equals(triggerValueForPanelHide)) {
